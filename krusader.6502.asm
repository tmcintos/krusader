...
; Notes:
;	- 0 bytes free (6 free if TABTOSPACE = 0)
;	- Entry points:
;		SHELL = $711C($F01C)
;		MOVEDN = $7304($F204)
;		DEBUG = -($FE14)
...
.if MINIMONITOR
.cwarn DEBUG   != $FE14, "DEBUG entry point changed!"
.cwarn XBRK    != $FE1E, "XBRK entry point changed!"
.endif
.cwarn DSMBL   != $FACA, "DSMBL entry point changed!"
...
.cwarn DSMBL   != $7BCA, "DSMBL entry point changed!"
.endif
