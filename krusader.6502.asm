...
.cerror DEBUG   != $FE14, "DEBUG entry point changed!"
.cerror XBRK    != $FE1E, "XBRK entry point changed!"
.cerror DSMBL   != $FACA, "DSMBL entry point changed!"
...
.cerror DSMBL   != $7BCA, "DSMBL entry point changed!"
.endif
